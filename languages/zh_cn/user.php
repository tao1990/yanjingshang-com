...
$_LANG['agreement'] = "我已看过并接受《<a href=\"article.php?id=112\" style=\"color:blue\" target=\"_blank\">用户协议</a>》";
...
$_LANG['register_success'] = '用户名:<font style="color:red;font-size:20px;font-weight:bold;">%s</font> 注册成功！3秒后将自动返回来源页...';
...
$_LANG['passport_js']['username_shorter'] = '5-20个字符';
$_LANG['passport_js']['username_invalid'] = '5-20个字符';
$_LANG['passport_js']['password_empty'] = '登录密码不能为空！';
$_LANG['passport_js']['password_shorter'] = '登录密码少于6个字符。';
$_LANG['passport_js']['confirm_password_invalid'] = '两次输入密码不一致';
$_LANG['passport_js']['email_empty'] = 'Email不能为空！';
$_LANG['passport_js']['email_invalid'] = 'Email不合法';
...
$_LANG['passport_js']['msg_un_length'] = '用户名不得超过7个汉字';
$_LANG['passport_js']['msg_un_format'] = '用户名含有非法字符';
$_LANG['passport_js']['msg_un_registered'] = '用户名已存在,请重输';
$_LANG['passport_js']['msg_can_rg'] = '可以注册';
$_LANG['passport_js']['msg_email_blank'] = '常用的电子邮件地址';
