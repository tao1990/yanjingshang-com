...
$_LANG['list_link'] = '关键词列表';
$_LANG['add_link'] = '添加新链接';
$_LANG['edit_link'] = '编辑关键词';
$_LANG['link_name_empty'] = '关键词名称不能为空！';
$_LANG['no_links'] = '您还没有添加关键词';

$_LANG['back_list'] = '返回关键词列表';
$_LANG['continue_add'] = '继续添加关键词';
...
$_LANG['link_name_empty'] = '关键词名称不能为空!';
$_LANG['link_url_empty'] = '关键词地址不能为空!';

$_LANG['link_logo_empty'] = '关键词LOGO不能为空!';
$_LANG['link_img_empty'] = '关键词的图片LOGO不能为空!';
