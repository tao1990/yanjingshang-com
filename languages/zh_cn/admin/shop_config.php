...
//------------------shop config: member email services----------------
//xyz:add 20130219
$_LANG['cfg_name']['member_email_services'] = '会员邮件服务';

$_LANG['cfg_name']['me_reg_welcome'] = '会员注册欢迎邮件';
$_LANG['cfg_name']['me_change_order_confirm'] = '订单确认邮件';
$_LANG['cfg_name']['me_change_order_send_goods'] = '订单发货邮件';
$_LANG['cfg_name']['me_change_order_modify'] = '订单修改邮件';
$_LANG['cfg_name']['me_change_order_return_goods'] = '订单退货邮件';
$_LANG['cfg_name']['me_warning_unpaid'] = '待支付订单付款提醒';
$_LANG['cfg_name']['me_warning_arrival_notice'] = '缺货商品到货提醒';
$_LANG['cfg_name']['me_warning_expired_coupon'] = '优惠券过期提醒';
$_LANG['cfg_name']['me_warning_withdraw_cash'] = '余额提现成功提醒';
$_LANG['cfg_name']['me_warning_user_rank'] = '会员身份变化提醒';
$_LANG['cfg_name']['me_warning_invite_user'] = '邀请已购物客户评论晒单';
$_LANG['cfg_name']['me_warning_expired_product'] = 'XX抛用户到期提醒';
$_LANG['cfg_name']['me_warning_full_month_user'] = '注册满一个月用户';
$_LANG['cfg_name']['me_warning_full_year_user'] = '注册满一年用户';

$_LANG['cfg_range']['me_reg_welcome']['1'] = '发送';
$_LANG['cfg_range']['me_reg_welcome']['0'] = '不发送';
$_LANG['cfg_range']['me_change_order_confirm']['1'] = '发送';
$_LANG['cfg_range']['me_change_order_confirm']['0'] = '不发送';
$_LANG['cfg_range']['me_change_order_send_goods']['1'] = '发送';
$_LANG['cfg_range']['me_change_order_send_goods']['0'] = '不发送';
$_LANG['cfg_range']['me_change_order_modify']['1'] = '发送';
$_LANG['cfg_range']['me_change_order_modify']['0'] = '不发送';
$_LANG['cfg_range']['me_change_order_return_goods']['1'] = '发送';
$_LANG['cfg_range']['me_change_order_return_goods']['0'] = '不发送';
$_LANG['cfg_range']['me_warning_unpaid']['1'] = '发送';
$_LANG['cfg_range']['me_warning_unpaid']['0'] = '不发送';
$_LANG['cfg_range']['me_warning_arrival_notice']['1'] = '发送';
$_LANG['cfg_range']['me_warning_arrival_notice']['0'] = '不发送';
$_LANG['cfg_range']['me_warning_expired_coupon']['1'] = '发送';
$_LANG['cfg_range']['me_warning_expired_coupon']['0'] = '不发送';
$_LANG['cfg_range']['me_warning_withdraw_cash']['1'] = '发送';
$_LANG['cfg_range']['me_warning_withdraw_cash']['0'] = '不发送';
$_LANG['cfg_range']['me_warning_user_rank']['1'] = '发送';
$_LANG['cfg_range']['me_warning_user_rank']['0'] = '不发送';
$_LANG['cfg_range']['me_warning_invite_user']['1'] = '发送';
$_LANG['cfg_range']['me_warning_invite_user']['0'] = '不发送';
$_LANG['cfg_range']['me_warning_expired_product']['1'] = '发送';
$_LANG['cfg_range']['me_warning_expired_product']['0'] = '不发送';
$_LANG['cfg_range']['me_warning_full_month_user']['1'] = '发送';
$_LANG['cfg_range']['me_warning_full_month_user']['0'] = '不发送';
$_LANG['cfg_range']['me_warning_full_year_user']['1'] = '发送';
$_LANG['cfg_range']['me_warning_full_year_user']['0'] = '不发送';
//------------------shop config: member email services----------------
...
$_LANG['cfg_desc']['integral_scale'] = '积分加价购的时候每1元要消耗多少积分，默认1元=100积分';
