...
$_LANG['lab_promote_price'] = '抢购价：';
$_LANG['lab_promote_date'] = '抢购日期：';
...
$_LANG['js_languages']['promote_not_lt'] = '抢购开始日期不能大于结束日期';
$_LANG['js_languages']['promote_start_not_null'] = '抢购开始时间不能为空';
$_LANG['js_languages']['promote_end_not_null'] = '抢购结束时间不能为空';
