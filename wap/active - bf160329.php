    ...
    if(!$smarty->is_cached('active'.$pid.'.dwt', $cache_id))
    {
        ...
        foreach($goodsArr1 as $v){
            if($v[0] == 1){
                ...
                $res['zk'] = $v[2];
                $res['fomart_price'] = '市场价<del>￥' . $res['market_price'] . '</del>';
                $res['href'] = 'http://m.easeeyes.com/category.php?h=1&keyword=NEO%E5%8F%AF%E8%A7%86%E7%9C%B8%E5%B7%A8%E7%9B%AE';
                $res['goods_name'] = 'NEO可视眸巨目系列隐形眼镜';
            }elseif($v[0] == 4){
                $res = $GLOBALS['db']->getRow("SELECT goods_id,goods_thumb,goods_name,market_price,shop_price,original_img,is_promote,promote_price FROM ".$GLOBALS['ecs']->table('goods')." WHERE goods_id = 2860");
                $res['promote_price'] = number_format($res['shop_price'],2);
                $res['zk'] = $v[2];
                $res['fomart_price'] = '市场价<del>￥' . $res['market_price'] . '</del>';
                $res['href'] = 'http://m.easeeyes.com/category.php?eyword=%E4%BC%8A%E5%8E%B6%E5%BA%B7%E5%86%B0%E6%B7%87%E6%B7%8B%E5%8D%8A%E5%B9%B4%E6%8A%9B%E5%BD%A9%E8%89%B2%E9%9A%90%E5%BD%A2%E7%9C%BC%E9%95%9C';
                $res['goods_name'] = '伊厶康冰淇淋半年抛彩色隐形眼镜';
            }elseif($v[0] == 5){
                $res = $GLOBALS['db']->getRow("SELECT goods_id,goods_thumb,goods_name,market_price,shop_price,original_img,is_promote,promote_price FROM ".$GLOBALS['ecs']->table('goods')." WHERE goods_id = 4135");
                ...
                $res['zk'] = $v[2];
                $res['fomart_price'] = '市场价<del>￥' . $res['market_price'] . '</del>';
                $res['href'] = 'http://m.easeeyes.com/category.php?h=1&keyword=Bescon+Tutti+Classic%E7%BB%8F%E5%85%B8%E5%A4%A7%E7%9B%B4%E5%BE%84%E7%B3%BB%E5%88%97%E5%8D%8A%E5%B9%B4%E6%8A%9B%E5%BD%A9%E8%89%B2%E9%9A%90%E5%BD%A2%E7%9C%BC%E9%95%9C1%E7%89%87%E8%A3%85';
                $res['goods_name'] = 'Bescon Tutti Classic经典大直径系列半年抛彩色隐形眼镜1片装';
            }elseif($v[0] == 8){
                ...
                $res['zk'] = $v[2];
                $res['fomart_price'] = '市场价<del>￥' . $res['market_price'] . '</del>';
                $res['href'] = 'http://m.easeeyes.com/category.php?h=1&keyword=Bescon%E6%A2%A6%E5%B9%BB%E5%8D%8A%E5%B9%B4%E6%8A%9B%E5%BD%A9%E8%89%B2%E9%9A%90%E5%BD%A2%E7%9C%BC%E9%95%9C1%E7%89%87%E8%A3%85';
                $res['goods_name'] = 'Bescon梦幻半年抛彩色隐形眼镜1片装';
            }elseif($v[0] == 9){
                ...
                $res['zk'] = $v[2];
                $res['fomart_price'] = '市场价<del>￥' . $res['market_price'] . '</del>';
                $res['href'] = 'http://m.easeeyes.com/category.php?h=1&keyword=Bescon+Tutti+Natural%E5%8D%95%E8%89%B2%E7%B3%BB%E5%88%97%E5%8D%8A%E5%B9%B4%E6%8A%9B%E5%BD%A9%E8%89%B2%E9%9A%90%E5%BD%A2%E7%9C%BC%E9%95%9C1%E7%89%87%E8%A3%85';
                $res['goods_name'] = 'Bescon Tutti Natural单色系列半年抛彩色隐形眼镜1片装';
            }elseif($v[0] == 10){
                $res = $GLOBALS['db']->getRow("SELECT goods_id,goods_thumb,goods_name,market_price,shop_price,original_img,is_promote,promote_price FROM ".$GLOBALS['ecs']->table('goods')." WHERE goods_id = 899");
                $res['promote_price'] = number_format($res['promote_price'],2);
                $res['zk'] = $v[2];
                $res['fomart_price'] = '市场价<del>￥' . $res['market_price'] . '</del>';
                $res['href'] = 'http://m.easeeyes.com/category.php?h=1&keyword=BESCON%E5%8F%8C%E8%89%B2%E9%92%BB%E7%9F%B3%E7%B3%BB%E5%88%97%E5%8D%8A%E5%B9%B4%E6%8A%9B%E5%BD%A9%E8%89%B2%E9%9A%90%E5%BD%A2%E7%9C%BC%E9%95%9C1%E7%89%87%E8%A3%85';
                $res['goods_name'] = 'BESCON双色钻石系列半年抛彩色隐形眼镜1片装';
            }elseif($v[0] == 11){
                $res = $GLOBALS['db']->getRow("SELECT goods_id,goods_thumb,goods_name,market_price,shop_price,original_img,is_promote,promote_price FROM ".$GLOBALS['ecs']->table('goods')." WHERE goods_id = 891");
                $res['promote_price'] = number_format($res['promote_price'],2);
                $res['zk'] = $v[2];
                $res['fomart_price'] = '市场价<del>￥' . $res['market_price'] . '</del>';
                $res['href'] = 'http://m.easeeyes.com/category.php?h=1&keyword=BESCON%E5%8F%8C%E8%89%B2%E6%B6%A6%E5%BD%A9%E7%B3%BB%E5%88%97%E5%8D%8A%E5%B9%B4%E6%8A%9B%E5%BD%A9%E8%89%B2%E9%9A%90%E5%BD%A2%E7%9C%BC%E9%95%9C1%E7%89%87%E8%A3%85';
                $res['goods_name'] = 'BESCON双色润彩系列半年抛彩色隐形眼镜1片装';
            }elseif($v[0] == 12){
