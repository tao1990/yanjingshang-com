...
function get_orders($st, $et) {
	$query_sql = "SELECT order_sn,order_status,shipping_status,pay_status,zipcode FROM ". $GLOBALS['ecs']->table('order_info') ." WHERE referer='wap_smzdm' AND add_time > ". $st ." AND add_time < ". $et ." ";
