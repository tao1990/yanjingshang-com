...
//        }
        ...
        $button = '<a class="cart_end_bt" style="background-image:url(http://www.easeeyes.com/themes/default/images/cart/pay_'.$order['pay_id'].'.gif);" href="https://www.alipay.com/cooperate/gateway.do?'.$param. '&sign='.md5($sign).'&sign_type=MD5" target="_blank"></a>';
		return $button;
    }
