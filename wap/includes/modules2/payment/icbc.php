...
class icbc {
    ...
    function get_code($order, $payment)
    {
		...
		$signMsgBase64 = $sign->signMsgBase64($tranData, "/var/www/easeeyes.com/current/icbc/Easeeyes.key", $password); //签名信息base64编码
		$certBase64 = $sign->certBase64($tranData, "/var/www/easeeyes.com/current/icbc/Easeeyes.key", "/var/www/easeeyes.com/current/icbc/Easeeyes.crt", $password); //证书信息base编码
