...
define('IMAGE_URL', "http://www.yunjingshang.com/");    // 线上
define('IMG_URL', "http://img.yunjingshang.com/");    // CDN 
define('FILE_URL', "http://file.yunjingshang.com/");    // CDN 
...
{
    $sql = "select cat_id,cat_name from ".$GLOBALS['ecs']->table('category')." where cat_id!=138 and is_show = 1 and parent_id= ".$parent_id;
