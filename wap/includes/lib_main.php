 ...
 * @return  void
 */
function show_message_wap($content, $links = '', $hrefs = '', $type = 'info', $auto_redirect = false)
{
    $msg['content'] = $content;
    ...
    $GLOBALS['smarty']->assign('ur_here',    $GLOBALS['_LANG']['sys_msg']); // 当前位置
    $GLOBALS['smarty']->assign('link',    $link); // 按钮名称
