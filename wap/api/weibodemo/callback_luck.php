...
if(isset($_REQUEST['code'])){
	...
	$keys['redirect_uri'] = 'http://www.easeeyes.com/api/sina/weibodemo/callback_luck.php';
	try
	{
...
{
	echo '<input type="button" value="授权失败,请重新登录" onclick="window.location=\'http://www.easeeyes.com/api/sina/weibodemo/sync_luck.php\'" style="margin:50px;" />';
}
?>
