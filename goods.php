...
{
	//$sql = "select l.*, g.goods_img, g.goods_thumb, g.original_img, g.shop_price, g.goods_name from ecs_link_goods as l left join ecs_goods as g on l.link_goods_id=g.goods_id where l.goods_id=".
//			$goods_id." and g.cat_id<>138 and g.goods_number>0 and g.is_delete=0 and g.is_on_sale=1 and g.is_alone_sale=1 limit 0,3;";
    $sql = "select l.*, g.goods_name,b.goods_id,b.b2b_shop_price from (ecs_link_goods as l left join ecs_goods as g on l.link_goods_id=g.goods_id) 
    left join b2b_goods as b on g.goods_id = b.goods_id where l.goods_id=".$goods_id." and g.cat_id<>138 and g.goods_number>0 and b.b2b_is_on_sale=1 
     limit 0,3;";
