...
class cardpay
{
   ...
   function get_code($order, $payment)
   {
		...
		//2013-08-02 xu:去掉8080端口
		$def_url  = '<div style="text-align:center"><form name="cardpay" style="text-align:center;" method="post" action="http://pc.ce9.com/pay_gate.ce" target="_blank">';
