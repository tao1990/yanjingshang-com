...
class alipay
{
    ...
    {
        $this->alipay();
        $this->alipay_partner = '2088421637909490';//合作商户id
        $this->alipay_account = 'yunjingshangvip@163.com';//支付宝账号
        $this->alipay_key = '2jidrvnqlw8n6bivaqp7ema22y96tsx0';//key
    }
...
//        }
        ...
        $payment['alipay_partner'] = $this->alipay_partner;//合作商户id
        $payment['alipay_account'] = $this->alipay_account;//支付宝账号
        $payment['alipay_key']     = $this->alipay_key;//key
        ...
        $parameter = array(
            ...
            'notify_url'        => return_url(basename(__FILE__, '.php'))."&isnotify=1",
        ...
        $button = '<a class="cart_end_bt" style="background-image:url(http://www.yunjingshang.com/themes/default/images/cart/pay_'.$order['pay_id'].'.gif);" href="https://www.alipay.com/cooperate/gateway.do?'.$param. '&sign='.md5($sign).'&sign_type=MD5" target="_blank"></a>';
		return $button;
    }
