...
class sf_express
{
    ...
    function calculate($goods_weight, $goods_amount, $goods_number, $area_id=0)
    {
		...
		//if(in_array($area_id, array(6,7,20)) && $_SERVER['REQUEST_TIME'] >= 1418313600 && $_SERVER['REQUEST_TIME'] <= 1418356800 && $goods_amount > 0)
		if(in_array($area_id, array(6,7,20)) && $_SERVER['REQUEST_TIME'] >= strtotime('2015-04-20 00:00:00') && $_SERVER['REQUEST_TIME'] <= strtotime('2015-04-23 00:00:00'))
		{
