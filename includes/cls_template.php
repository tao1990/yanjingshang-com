...
class cls_template
{
    ...
    function html_select_date($arr)
    {
        ...
        $out = "<select name=\"{$pre}Year\"><option value=\"0\">- - - -</option>";
        ...
        {
            $out .= "</select> 年 <select name=\"{$pre}Month\"><option value=\"0\">- -</option>";
            for ($i = 1; $i <= 12; $i++)
            {
        ...
        {
            $out .= "</select> 月 <select name=\"{$pre}Day\"><option value=\"0\">- -</option>";
            for ($i = 1; $i <= 31; $i++)
            {
