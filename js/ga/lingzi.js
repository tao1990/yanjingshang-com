...
{
	var unit_id     = "2322564";
	var client_ip   = "119.167.195.162";
	var server_time = "1345344343";
	var verify_code = "7f98787a";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2322564/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
